...
( 
    ...
    [usu_usuario]			VARCHAR(20) NULL,
    [usu_senha] 			VARCHAR(10) NULL,
    [usu_foto] 				image NULL,
    [regra_cod]				INT NOT NULL,
)
go

CREATE TABLE [nivelacesso]
(
	[regra_cod] 				INT NOT NULL IDENTITY (1,1),
    [regra_nome]				VARCHAR(50) NULL,
)
go
...
ALTER TABLE [nivelacesso]
	ADD CONSTRAINT [XPKnivelacesso] PRIMARY KEY NONCLUSTERED ([regra_cod] ASC)
go

ALTER TABLE [usuario]
	ADD CONSTRAINT [R_90] FOREIGN KEY ([regra_cod]) REFERENCES [nivelacesso](regra_cod)
	ON DELETE NO ACTION
	ON UPDATE NO ACTION
go
...
( 
	...
	[emp_rsocial]        varchar(95)  NULL ,
	[emp_ie]             varchar(95)  NULL ,
	[emp_cnpj]           varchar(95)  NULL ,
	[emp_cep]            varchar(95)  NULL ,
	[emp_endereco]       varchar(95)  NULL ,
	[emp_bairro]         varchar(95)  NULL ,
	[emp_fone]           varchar(95)  NULL ,
	[emp_cel]            varchar(95)  NULL ,
	[emp_email]          varchar(95)  NULL ,
	[emp_endnumero]      varchar(95)  NULL ,
	[emp_cidade]         varchar(95)  NULL ,
	[emp_estado]         varchar(95)  NULL 
)
go
...
/* NOVA ATUALIZAÇÃO 28/01/2018 */
CREATE TABLE [funcionario]
( 
	[fun_cod]				int			 NOT NULL  IDENTITY ( 1,1 ) ,
	[fun_nome]				varchar(95)  NULL,
	[fun_matricula]			varchar(95)  NULL,
	[fun_cpf]				varchar(95)  NULL,
	[fun_rg]				varchar(95)  NULL,
	[fun_orgaoemissor]      varchar(95)  NULL,
	[fun_rgemissao]			DATETIME     NULL,
	[fun_datanascimento]    DATETIME     NULL,
	[fun_sexo]				varchar(95)  NULL,
	[fun_estadocivil]       varchar(95)  NULL,
	[fun_numfilhos]         int  NULL,
	[fun_nomeconjuge]		varchar(95)  NULL,
	[fun_telefone]          varchar(95)  NULL,
	[fun_celular]           varchar(95)  NULL,
	[fun_formacao]          varchar(95)  NULL,
	[fun_tituloeleitor]     varchar(95)  NULL,
	[fun_zonaeleitor]       varchar(95)  NULL,
	[fun_secaoeleitor]      varchar(95)  NULL,
	[fun_emissaoeleitor]	DATETIME     NULL,
	[fun_reservista]        varchar(95)  NULL,
	[fun_cnh]				varchar(95)  NULL,
	[fun_emissaocnh]		DATETIME     NULL,
	[fun_validadecnh]		DATETIME     NULL,
	[fun_categoriacnh]		varchar(10)  NULL,
	[fun_numctps]           varchar(95)  NULL,
	[fun_seriectps]         varchar(95)  NULL,
	[fun_datactps]			datetime	 NULL,
	[fun_numpis]			varchar(95)  NULL,
	[fun_funcaoexercida]    varchar(95)  NULL,
	[fun_admissao]          DATETIME     NULL,
	[fun_demissao]          varchar(95)  NULL,
	[fun_salariobase]       money		 NULL,
	[fun_salarioextra]      money		 NULL,
	[fun_ajudacusto]        money	     NULL,
	[fun_cep]				varchar(20)  NULL,
	[fun_endereco]          varchar(95)  NULL,
	[fun_bairro]			varchar(95)  NULL,
	[fun_endnumero]         varchar(10)  NULL,
	[fun_cidade]			varchar(95)  NULL,
	[fun_estado]			varchar(95)  NULL,
	[fun_banconome]         varchar(95)  NULL,
	[fun_bancoagencia]      varchar(95)  NULL,
	[fun_bancoconta]        varchar(95)  NULL,
	[fun_bancodata]			datetime	 NULL,
	[fun_foto]				image        NULL,
	[ben_cod]				int          NULL
)
go
...
ALTER TABLE [funcionario]
	ADD CONSTRAINT [R_100] FOREIGN KEY ([ben_cod]) REFERENCES [beneficio]([ben_cod])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go

ALTER TABLE [funcionario]
	ADD CONSTRAINT [R_101] FOREIGN KEY ([his_cod]) REFERENCES [historico]([his_cod])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
(
	[ben_cod]		int			 NOT NULL  IDENTITY ( 1,1 ) ,
	[ben_nome]		varchar(95)  NULL
)
go

ALTER TABLE [beneficio]
	ADD CONSTRAINT [XPKbeneficio] PRIMARY KEY  NONCLUSTERED ([ben_cod] ASC)
go

CREATE TABLE [historico]
(
	[his_cod]			int   NOT NULL  IDENTITY ( 1,1 ) ,
	[his_descricao]		text  NULL,
	[fun_cod]			int	  NULL
)
go

ALTER TABLE [historico]
	ADD CONSTRAINT [XPKhistorico] PRIMARY KEY  NONCLUSTERED ([his_cod] ASC)
go

ALTER TABLE [historico]
	ADD CONSTRAINT [R_200] FOREIGN KEY ([fun_cod]) REFERENCES [funcionario]([fun_cod])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
( 
	[log_cod]            int  NOT NULL  IDENTITY ( 1,1 ) ,
	[log_data]           datetime not null,
	[log_usu]			 varchar(95) NOT null
)
go

ALTER TABLE [logAcesso]
	ADD CONSTRAINT [XPKlogAcesso] PRIMARY KEY  NONCLUSTERED ([log_cod] ASC)
go
